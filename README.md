...
(Reference to your uploaded diagram)
...
The team leader initializes and pushes the main repository to GitHub.

Members clone the same repository to their PCs.

Each member works on a separate branch (feature-based workflow).

Changes are committed, pushed, and merged into the main branch after review.
...
Open it in Apache NetBeans.

Run the main class (e.g. MediaApp.java or Main.java).

Ensure required .csv files are placed in the correct directory.

Explore features via the GUI interface.

🧩 Example OOP Concepts Used
OOP Concept	Example
Encapsulation	Private attributes with getters/setters in Student and Course classes
Inheritance	Admin and Lecturer extending User superclass
Polymorphism	Overridden generateReport() methods for different user roles
Abstraction	Abstract Report class implemented by PerformanceReport
📦 Deliverables

GUI-driven working prototype

Program documentation (Design + OOP justification)
...
🧾 Acknowledgment
Yes, this readme file was created by AI. I don't want to spend my time to write this LMAO:D
Developed by students of Asia Pacific University (APU)
as part of the CT038-3-2 Object Oriented Development with Java coursework (2025).
